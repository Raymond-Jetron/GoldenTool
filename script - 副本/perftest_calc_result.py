...
''' 
使用说明：
[参数1] 生成文件的程序名，有两个可选： MakeData   QueryData
传入相对路径：
python perftest_calc_result.py MakeData result/log.csv
传入绝对路径：
python perftest_calc_result.py QueryData /home/PerfTest/result/log.csv
 '''
import sys
import os
import time
...
def main(argv):
    ...
    with open(result_file_path,"r") as f:
        if exec_name == "QueryData" :
            ...
            print("Invalid parameter, you must choose from : [MakeData QueryData]")
