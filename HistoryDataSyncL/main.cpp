...
int main(int argc, char* argv[])
{
	...
	CLI::App app{ "App description" };
	{
		...
		golden_config::source_password_ = "golden";
		app.add_option("--source_password", golden_config::source_password_, "source pass word (=golden)");
		...
		golden_config::sink_password_ = "golden";
		app.add_option("--sink_password", golden_config::sink_password_, "sink pass word (=golden)");
