...
/**
* \ingroup ddatatype
* \typedef struct _GOLDEN_COORDINATE GOLDEN_COORDINATE
* \brief 坐标类型
* \see _GOLDEN_COORDINATE
*/
...
/**
* \ingroup ddatatype
* \typedef unsigned char golden_byte
* \brief   单字节数值
*/
typedef unsigned char       golden_byte;
/**
* \typedef char golden_int8
* \ingroup ddatatype
* \brief 8位整数
*/
typedef char                golden_int8;
/**
* \typedef unsigned char golden_uint8
* \ingroup ddatatype
* \brief 8位正整数
*/
typedef unsigned char       golden_uint8;
/**
* \typedef short golden_int16
* \ingroup ddatatype
* \brief 16位整数
*/
typedef short               golden_int16;
/**
* \typedef unsigned short golden_uint16
* \ingroup ddatatype
* \brief 16位正整数
*/
typedef unsigned short      golden_uint16;
/**
* \typedef int golden_int32
* \ingroup ddatatype
* \brief 32位整数
*/
typedef int                 golden_int32;
/**
* \typedef unsigned int golden_uint32
* \ingroup ddatatype
* \brief 32位正整数
*/
typedef unsigned int        golden_uint32;
#ifdef WIN32
typedef long long           golden_int64;         /// 64位整数
typedef unsigned long long  golden_uint64;        /// 64位正整数
#else
/**
* \typedef long int golden_int64
* \ingroup ddatatype
* \brief 64位整数
*/
typedef long int            golden_int64;
/**
* \typedef unsigned long int golden_uint64
* \ingroup ddatatype
* \brief 64位正整数
*/
typedef unsigned long int   golden_uint64;
#endif // WIN32
/**
* \typedef short golden_float16
* \ingroup ddatatype
* \brief 16位浮点数
*/
typedef short               golden_float16;
/**
* \typedef float golden_float32
* \ingroup ddatatype
* \brief 32位浮点数
*/
typedef float               golden_float32;
/**
* \typedef double golden_float64
* \ingroup ddatatype
* \brief 64位浮点数
*/
typedef double              golden_float64;
/**
* \typedef GOLDEN_COORDINATE golden_coordinate
* \ingroup ddatatype
* \brief 二维坐标
*/
typedef GOLDEN_COORDINATE   golden_coordinate;
/**
* \typedef unsigned int golden_error
* \ingroup ddatatype
* \brief 错误数值
*/
typedef unsigned int        golden_error;
/**
* \typedef void* golden_datagram_handle
* \ingroup ddatatype
* \brief UDP连接句柄
*/
...
/**
* \ingroup dmacro
* \def GOLDEN_QUALITY_MODIFY_UPDATE_FLAG(Q, U)
...
/**
* \ingroup dmacro
* \def GOLDEN_QUALITY_IS_UPDATED(Q)
...
/**
* \ingroup dmacro
* \def GOLDEN_QUALITY_WITHOUT_FLAG(Q)
...
/**
* \ingroup dmacro
* \def GOLDEN_QUALITY_FROM_OPC(OPC_Q)
* \brief 从OPC协议获取的质量码，使用此宏转换为GOLDEN中对应的质量码.
...
/**
* \ingroup dmacro
* \def GOLDEN_QUALITY_IS_OPC(Q)
* \brief 判定GOLDEN中的质量码是否属于OPC协议范围.
* \param Q GOLDEN中的质量码
*/
...
/**
* \ingroup dmacro
* \def GOLDEN_QUALITY_TO_OPC(Q)
* \brief GOLDEN中属于OPC协议范围的质量码，使用此宏还原为OPC原始质量码.
* \param Q GOLDEN中属于OPC协议范围的质量码
*/
#define GOLDEN_QUALITY_TO_OPC(Q)                  ( GOLDEN_Q_GOOD == GOLDEN_QUALITY_WITHOUT_FLAG(Q) ? GOLDEN_QUALITY_OPC_GOOD : (Q) & 0xFF )

/**
* \ingroup dmacro
* \def GOLDEN_QUALITY_IS_VALID(Q)
...
/**
* \ingroup dmacro
* \def GOLDEN_QUALITY_IS_REMOVED(Q)
...
/**
* \ingroup dmacro
* \def GOLDEN_TYPE_IS_NORMAL(TYPE)
*      )
* \brief 判断此数据类型是否是除 \b GOLDEN_STRING 、\b GOLDEN_BLOB、\b GOLDEN_NAMED_T 之外的数据类型
* \param TYPE  数据类型
* \see GOLDEN_TYPE
*/
#define GOLDEN_TYPE_IS_NORMAL(TYPE)    ( (TYPE == GOLDEN_STRING || TYPE == GOLDEN_BLOB || TYPE == GOLDEN_NAMED_T) ? false : true )
...
/**
* \ingroup dmacro
* \def GOLDEN_CLASS_IS_SCAN(CLASSOF)
* \brief 判定标签点是否采集标签点.
* \param CLASSOF 标签点类别
* \see GOLDEN_CLASS
*/
...
/**
* \ingroup dmacro
* \def GOLDEN_CLASS_IS_CALC(CLASSOF)
* \brief 判定标签点是否计算标签点.
* \param CLASSOF 标签点类别
* \see GOLDEN_CLASS
*/
...
/**
* \ingroup dmacro
* \def GOLDEN_CLASS_IS_ALARM(CLASSOF)
* \brief 判定标签点是否报警标签点.
* \param CLASSOF 标签点类别
* \see GOLDEN_CLASS
*/
...
enum GOLDEN_HIS_MODE
{
  ...
  GOLDEN_EXACT,           //!< 取指定时间的数据，如果没有则返回错误 \b GoE_DATA_NOT_FOUND；
...
{
  GOLDEN_PROCESS_FIRST = 1,                         //!< 计数作用
  GOLDEN_PROCESS_HISTORIAN = GOLDEN_PROCESS_FIRST,  //!< 历史服务
  GOLDEN_PROCESS_EQUATION,                          //!< 方程式服务
  GOLDEN_PROCESS_BASE,                              //!< 标签点服务
  GOLDEN_PROCESS_LAST,                              //!< 计数作用
};
...
/**
* \ingroup ddatatype
* \typedef enum GOLDEN_POINT_MIRROR
* \brief 标签点镜像属性
* \see _GOLDEN_TABLE
*/
enum GOLDEN_POINT_MIRROR
{
	GOLDEN_POINT_OFF = 0,		//!<镜像关闭
	GOLDEN_POINT_SEND_RECV = 1, //!<镜像收发
	GOLDEN_POINT_RECV = 2,		//!<镜像接收
	GOLDEN_POINT_SEND = 3		//!<镜像发送
};

/**
* \ingroup ddatatype
* \typedef struct _GOLDEN_TABLE GOLDEN_TABLE
* \brief 标签点索引表属性集
* \see _GOLDEN_TABLE
*/
...
typedef struct _GOLDEN_TABLE
{
  ...
  *  3、不允许使用以下字符（'*'、'''、'?'、';'、'{'、'}'、'['、']'、'|'、'\'、'`'、'''、'"'、'.'）；
  *  4、字节长度不要超出 \b GOLDEN_TAG_SIZE，如果超出，系统会自动将后面的字符截断。
  */
  char name[GOLDEN_TAG_SIZE];
  /**
  *  表描述。
  *  缺省值：空字符串。
  *  字节长度不要超出 \b GOLDEN_DESC_SIZE，多余的部分会被截断。
  */
...
/**
* \ingroup ddatatype
* \typedef struct _GOLDEN_POINT GOLDEN_POINT
* \brief 基本标签点属性集
* \see _GOLDEN_POINT
*/
/**
...
typedef struct _GOLDEN_POINT
{
  ...
  */
  ...
  /**
  *  工程单位。
  *  字节长度不要超出 \b GOLDEN_UNIT_SIZE，多余的部分会被截断。
  */
...
/**
* \ingroup ddatatype
* \typedef struct _GOLDEN_SCAN_POINT GOLDEN_SCAN_POINT
* \brief 采集标签点扩展属性集
* \see _GOLDEN_SCAN_POINT
*/
/**
* \ingroup dstruct
...
typedef struct _GOLDEN_SCAN_POINT
{
  ...
  *  缺省值：空（NULL）；
  *  将标签点同某些接口或某些模块相关联；
  *  每个数据源字符串只允许由26个字母（大小写敏感）和数字（0-9）组成，字节长度不要超出 \b GOLDEN_SOURCE_SIZE，多余的部分会被截断。
  */
  ...
  *  设备标签。
  *  缺省值：空（NULL）；
  *  字节长度不要超出 \b GOLDEN_INSTRUMENT_SIZE，多余的部分会被截断。
  */
...
/**
* \ingroup ddatatype
* \typedef struct _GOLDEN_CALC_POINT GOLDEN_CALC_POINT
* \brief 计算点扩展属性集
* \see _GOLDEN_CALC_POINT
*/
/**
* \ingroup dstruct
...
typedef struct _GOLDEN_CALC_POINT
{
  ...
  *  实时方程式。
  *  缺省值：空（NULL）；
  *  字节长度不要超出 \b GOLDEN_EQUATION_SIZE，长度超长的方程式将被拒绝设置入库，返回一个错误，避免错误的方程式进入系统，引发不安全因素。
  */
  char equation[GOLDEN_EQUATION_SIZE];
  /**
  *  计算触发机制。枚举值参见 \b GOLDEN_TRIGGER。
  *  仅对"计算"类别标签点起作用，用于设置实时方程式服务对单个计算点的计算触发采用"事件触发"还是"周期触发"，
  *  对于"周期触发"以"事件触发"作为其先决判断条件，如果"事件触发"不满足，则不进行"周期触发"。
  */
  golden_byte trigger;
  /**
  *  计算结果时间戳参考, 枚举值参见 \b GOLDEN_TIME_COPY
  *  0: 表示采用计算时间作为计算结果时间戳；
...
/**
* \ingroup ddatatype
* \typedef struct _GOLDEN_MAX_CALC_POINT GOLDEN_MAX_CALC_POINT
* \brief 最大长度计算点扩展属性集
* \see _GOLDEN_MAX_CALC_POINT
*/
/**
* \ingroup dstruct
...
typedef struct _GOLDEN_MAX_CALC_POINT
{
  ...
  *  实时方程式。
  *  缺省值：空（NULL）；
  *  字节长度不要超出 \b GOLDEN_MAX_EQUATION_SIZE，长度超长的方程式将被拒绝设置入库，返回一个错误，避免错误的方程式进入系统，引发不安全因素。
  */
...
* \ingroup denum
* \brief 操作系统类型
* \see go_get_linked_ostype
*/
enum GOLDEN_OS_TYPE
{
  GOLDEN_OS_WINDOWS,        //!< Windows 操作系统
  GOLDEN_OS_LINUX,          //!< Linux 操作系统
  GOLDEN_OS_INVALID = 50,   //!< 无效的操作系统
};
...
* \see gob_tags_change_event gob_subscribe_tags
*/
...
/**
* \ingroup ddatatype
* \typedef struct _GOLDEN_HEADER_PAGE GOLDEN_HEADER_PAGE
* \brief 历史数据存档文件头部信息
* \see _GOLDEN_HEADER_PAGE
*/
...
typedef struct _GOLDEN_HEADER_PAGE
{
  ...
  int begin;                              //!< 数据起始时间
  int end;                                //!< 数据结束时间
  golden_int64 real_size;                 //!< 实际写入的字节数 用来统计实际使用率
  ...
  golden_int64 rated_capacity;            //!< 创建时容量（额定容量）
  golden_int64 capacity;                  //!< 当前容量，文件内包含的总数据页数，不包括头页。
  golden_int64 size;                      //!< 实际使用量，已被占用的数据页数，不包括头页。
  golden_int64 ex_capacity;               //!< 附属文件容量
...
#define GOLDEN_MAX_HOSTNAME_SIZE        1024
 ...
 /**
 * \ingroup ddatatype
 * \typedef struct _GOLDEN_HOST_CONNECT_INFO GOLDEN_HOST_CONNECT_INFO
 * \brief 连接到GOLDEN数据库服务器的连接信息
 * \see _GOLDEN_HOST_CONNECT_INFO
 */

 /**
 * \ingroup ddatatype
 * \typedef struct _GOLDEN_HOST_CONNECT_INFO *PGOLDEN_HOST_CONNECT_INFO
 * \brief 连接到GOLDEN数据库服务器的连接信息
 * \see _GOLDEN_HOST_CONNECT_INFO
 */
...
/*
* \ingroup ddatatype
* \typedef struct _GOLDEN_GRAPH_DATA GOLDEN_GRAPH_DATA
* \brief 计算标签点方程式拓扑图键值对信息
* \see _GOLDEN_GRAPH_DATA
*/
...
* \brief 计算标签点方程式拓扑图键值对信息
*/
typedef struct _GOLDEN_GRAPH_DATA
{
  int id;                               //!< 标签点ID
...
{
  GOLDEN_SORT_FLAG_DESCEND = 0x0001,        //!< 降序
  GOLDEN_SORT_FLAG_CASE_SENSITIVE = 0x0002, //!< 大小写敏感
  GOLDEN_SORT_FLAG_RECYCLED = 0x0004,       //!< 用于回收站标签点排序
};
...
/**
* \ingroup ddatatype
* \typedef struct _GOLDEN_DATA_TYPE_FIELD GOLDEN_DATA_TYPE_FIELD
* \brief 组成自定义类型的字段定义
* \see _GOLDEN_DATA_TYPE_FIELD
*/
...
{
  char         name[GOLDEN_TYPE_NAME_SIZE]; //!< 自定义类型的字段的名称，不要大于\b GOLDEN_TYPE_NAME_SIZE个字节
  golden_int32 type;                        //!< 字段的类型,只支持 \b GOLDEN_TYPE 里的类型，不支持struct，union等组合类型。
  golden_int32 length;                      //!< 字段类型的长度, \b GOLDEN_STRING、\b GOLDEN_BLOB等类型的具体的长度，基本类型本身的长度(基本类型可以忽略)，单位：字节。
  char         desc[GOLDEN_DESC_SIZE];      //!< 字段类型的描述，不要大于 \b GOLDEN_DESC_SIZE个字节
...
/**
* \ingroup ddatatype
* \typedef struct _GOLDEN_CONNECT_EVENT GOLDEN_CONNECT_EVENT
* \brief 每个数据库连接的调用信息
* \see _GOLDEN_CONNECT_EVENT
*/
...
/**
* \ingroup ddatatype
* \typedef struct _GOLDEN_ARCHIVE_PERF_DATA GOLDEN_ARCHIVE_PERF_DATA
* \brief 每个存档文件的性能信息，重启服务后会重新统计
* \see _GOLDEN_ARCHIVE_PERF_DATA
*/
...
* \param what      整型，参考枚举 \b GOLDEN_TAG_CHANGE_REASON,
*                    表示引起变更的源类型。
* \see gob_subscribe_tags
*/
typedef
golden_error
...
* \param param			void指针，输入，用户调用gob_subscribe_tags_ex时param参数
* \param count		    整型，输入，event_type为GOLDEN_E_DATA时表示标签点个数，否则count为0
* \param ids			整型数组，输入，标签点被订阅且属性发生更改的标识列表
* \param what			整型，参考枚举 GOLDEN_TAG_CHANGE_REASON,
*		                表示引起变更的源类型。
* \see GOLDEN_EVENT_TYPE
*/
typedef
golden_error
...
* \remark 本接口对数据类型为 GOLDEN_COOR、GOLDEN_STRING、GOLDEN_BLOB 的标签点无效。
*/
typedef
golden_error
(*gos_snaps_event)(
...
* \param handle      整型，输入，产生通知的句柄
* \param param       void指针，输入，用户调用gos_subscribe_snapshots_ex时param参数
* \param count       整型，输入，
					   表示 ids、datetimes、ms、values、states、qualities、errors的长度
* \param ids         整型数组，输入，标签点被订阅且快照发生改变的标识列表
* \param datatimes   整型数组，输入，实时数值时间列表，
...
/**
* \ingroup dcallback
* \brief 自定义类型删除通知订阅回调接口
* \parma name     自定义类型的名称,输入，长度不超过GOLDEN_TYPE_NAME_SIZE
*/
typedef
golden_error
(*gob_named_type_remove_event)(
  const char* name
  );
...
/**
* \ingroup dcallback
* \brief 自定义类型添加通知订阅回调接口
* \param name     自定义类型的名称,输入，长度不超过GOLDEN_TYPE_NAME_SIZE
*/
typedef
golden_error
(*gob_named_type_create_event)(
  const char* name,
  long field_count,
...
(*go_connect_event)(
  golden_int32 count,
  const GOLDEN_CONNECT_EVENT* const* events,
...
* \param event_type   无符号整形，输入，通知类型
* \param handle       整型，输入，产生通知的句柄
* \param param        void指针，输入，用户调用go_subscribe_connect_ex时param参数
* \param count        连接调用events的个数
* \param events       连接调用信息
* \param pre_calls    连接调用时传入的参数信息
* \param post_calls   连接调用后传出的参数信息
* \see GOLDEN_EVENT_TYPE
*/
typedef golden_error(*go_connect_event_ex)(
  golden_uint32 event_type,
  golden_int32 handle,
  void* param,
  golden_int32 count,
...
#else
#define GOLDEN_DISTANCE(X1, Y1, X2, Y2)             sqrt( GOLDEN_ABS(X1, X2) * GOLDEN_ABS(X1, X2) + GOLDEN_ABS(Y1, Y2) * GOLDEN_ABS(Y1, Y2) )
#endif
...
/**
* \ingroup dmacro
* \def GOLDEN_API_MAJOR_VERSION
* \brief API的主版本号
*/
#define GOLDEN_API_MAJOR_VERSION      3
/**
* \ingroup dmacro
* \def GOLDEN_API_MINOR_VERSION
* \brief API的副版本号
*/
#define GOLDEN_API_MINOR_VERSION      0
/**
* \ingroup dmacro
* \def GOLDEN_API_BETA_VERSION
* \brief API的发行版本号
*/
#define GOLDEN_API_BETA_VERSION       9
