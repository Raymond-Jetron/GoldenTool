...
#define GoE_POINT_HARDWARE_LIMITED                          0xFFFF005D  // 由于硬件资源限制，创建或恢复标签点失败
...
#define GoE_SUBSCRIBE_ERROR                                 0xFFFF2027  // 订阅失败，前一个订阅线程尚未退出，请稍后重试
#define GoE_SUBSCRIBE_CANCEL_ERROR                          0xFFFF2028  // 取消订阅失败
#define GoE_SUBSCRIBE_CALLBACK_FAILED                       0xFFFF2029  // 订阅回掉函数中不能调用取消订阅、断开连接
#define GoE_SUBSCRIBE_GREATER_MAX_COUNT                     0xFFFF2030  // 超过单连接可订阅标签点数量
