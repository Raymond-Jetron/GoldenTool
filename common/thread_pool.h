...
// the constructor just launches some amout of workers
inline thread_pool::thread_pool(size_t threads) : stop(true)
{
    init(threads);
}

inline thread_pool::thread_pool() : stop(true)
{}
...
inline size_t thread_pool::wait_tasks_size()
{
    return tasks.size();
}